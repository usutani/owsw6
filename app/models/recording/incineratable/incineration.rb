class Recording::Incineratable::Incineration
  ...
  private
    ...
    def due?
      @bucket.recording < Recording::Incineratable::INCINERATABLE_AFTER.ago.end_of_day
    end

    def incinerate_chilern(recording)
    ...
    # Recordables can be shared between recordings and may cncounter a
    # race condition when being incineratd. Retry incineration in this case.
    def rerun_incineration(recording)
